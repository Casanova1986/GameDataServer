export var Equip_TypeEquipment = ['Weapon', 'Garment', 'Ring', 'Amulet', 'Helmet', 'Cape', 'Artifact'];

export var subStatType = ['Atk', 'Atk Spd', 'Crit Chance', 'Crit Dmg', 'Armor', 'Magic Res', 'HP'];
...
export enum levelEquipment {
  minLevel = 1,
  maxLevel = 20,
}
export var Equip_Price = [
